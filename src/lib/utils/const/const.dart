...
const totalOnboarding = 8;

/// Onboarding Header Tag
const onBoardingHeaderTag = 'ONBOARDING_HEADER_TAG';

/// File path: assets/documents/COPPA_Regulation.rtf
const pathCompliantStatement = 'assets/documents/Compliant_Statement.txt';

/// File path: assets/documents/Terms_of_Services.rtf
const pathTermsOfServices = 'assets/documents/Terms_of_Services.txt';

/// Contact email address
const defaultContactEmail = 'contact@walturn.com';
